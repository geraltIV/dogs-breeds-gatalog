<template>
  <div
    class="card"
    :style="{
      background: `linear-gradient(1.26deg, #000000 -5.53%, rgba(0, 0, 0, 0) 54.45%), url(${imageUrl}) no-repeat`,
    }"
  >
    <button
    ...
    >
      ...
      >
        <path
          d="M13.7579 25.6993C14.1703 26.1002 14.8297 26.1002 15.2421 25.6993L26.3754 14.8743C29.8749 11.4716 29.8749 5.9453 26.3754 2.54267C23.1264 -0.61635 18.0044 -0.831789 14.5 1.89635C10.9956 -0.831789 5.87363 -0.61635 2.62465 2.54267C-0.874882 5.9453 -0.874882 11.4716 2.62465 14.8743L13.7579 25.6993Z"
          fill="white"
        />
      </svg>
    ...
    <h3 class="breed-name">{{ breed | nameFilter(breed) }}</h3>
  </div>
</template>
